...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Definicion de Requisicion ссссссссс</h1>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <label class="d-block col-form-label p-0" for="inputSuccess"><i class="fas fa-check"></i> Fecha: <span class="text-custom1">${generalData}</span> </label>
                    <label class="d-block col-form-label p-0" for="inputSuccess"><i class="fas fa-check"></i> Empresa: <span class="text-custom1">${generalData}</span> </label>
                    <label class="d-block col-form-label p-0" for="inputSuccess"><i class="fas fa-check"></i> Departamento: <span class="text-custom1">${generalData}</span></label>
                    <label class="d-block col-form-label p-0" for="inputSuccess"><i class="fas fa-check"></i> Solicitante: <span class="text-custom1">${generalData}</span></label>
                    <label class="d-block col-form-label p-0" for="inputSuccess"><i class="fas fa-check"></i> Autorizador: <span class="text-custom1">${generalData}</span></label>                      
                    </div>
                    <div class="col-md-6">
                        <div class="description-block  border-bottom mb-1 rounded" style="background-color:rgba(0,0,0,.03);">
                          ...
                          <span class="description-text">${generalData}</span>
                        </div>                    
                        <div class="description-block  border-bottom mb-1 rounded" style="background-color:rgba(0,0,0,.03);">
                        ...
                        <div class="description-block  border-bottom mb-1 rounded" style="background-color:rgba(0,0,0,.03);">
                          <h5 class="description-header text-success">${generalData}</h5>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><span class="badge bg-warning"> $ 55.78</span></td>
                    </tr>
                  </tbody>
                </table>
