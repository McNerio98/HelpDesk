...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="contenedor">
            <div class="border border-secondary profile-panel-main bg-light">
                <form action="${pageContext.servletContext.contextPath}/Perfil?accion=update" style="width: 100%;" method="POST" id="formProfile">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">   
                            ...
                            <input type="text" class="form-control" id="txtNombre"  name="txtNombre" value="${Us.firstName}" disabled="true" maxlength="20">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <button type="submit" class="btn btn-primary" id="commitChange" style="display: none;">Confirmar</button>
                    <button type="button" class="btn btn-primary" id="enabledEdit">Modificar</button>
                </form>
